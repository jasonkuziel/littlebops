  ...
  try {
    ...
    if (tier === "song_video" || tier === "star_bundle") {
      ...
      if (videoResult.clips && videoResult.clips[0]) {
        const videoResponse = await fetch(videoResult.clips[0]);
